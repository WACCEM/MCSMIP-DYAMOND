"""
Replaces MCS tracking pixel-level data lat/lon with that from a reference grid file.
...
if __name__=='__main__':
    ...
    in_dir = f'/pscratch/sd/f/feng045/DYAMOND/{phase}/{run_name}/mcstracking/20200120.0000_20200301.0000/'
    out_dir = f'/pscratch/sd/f/feng045/DYAMOND/{phase}/{run_name}/mcstracking/test/'
