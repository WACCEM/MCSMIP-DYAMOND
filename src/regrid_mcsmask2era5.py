...
if __name__ == "__main__":
    ...
    # Input file name
    in_dir = f'/pscratch/sd/f/feng045/DYAMOND/mcs_mask/{PHASE}/{tracker}/'
    in_filename = f'{in_dir}mcs_mask_{PHASE}_{runname}.nc'
    # Output file name
    out_dir = f'/pscratch/sd/f/feng045/DYAMOND/mcs_mask_regrid/{PHASE}/{tracker}/'
