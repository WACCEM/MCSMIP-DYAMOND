...
if __name__ == "__main__":
    ...
    # Input file name
    in_dir = '/pscratch/sd/f/feng045/DYAMOND/OLR_Precipitation_combined/'
    in_filename = f'{in_dir}olr_pcp_{PHASE}_{runname}.nc'
    # Output file name
    out_dir = '/pscratch/sd/f/feng045/DYAMOND/OLR_Precipitation_combined_regrid/'
    ...
    # Retrieve Regridder
    regridder = xe.Regridder(grid_src, grid_dst, method=regrid_method, weights=weight_filename_conserv)
